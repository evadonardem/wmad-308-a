...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Alvarez Nigela',
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 2, 17, 58),
          ),
        ),
        home: MyHomePage(),
      ),
...
class MyAppState extends ChangeNotifier {
  ...
  var favorites = <WordPair>[]; // List of favorites
  var dislikes = <WordPair>[]; // List of dislikes
  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedIndex) {
      ...
      case 1:
        ...
        break;
      case 2:
        page = DislikePage(); // Navigate to DislikePage
        break;
      case 3:
        page = AboutMePage(); // Navigate to AboutMePage
        break;
      default:
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            // A text below the box
            Text('ANNYEONGHASEYO!! EME LANG !!', textAlign: TextAlign.center),
          ],
        ),
      ),
    );
