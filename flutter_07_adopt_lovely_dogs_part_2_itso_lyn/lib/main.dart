...
class FavoritesScreen extends StatelessWidget { 
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.lightBlue[50], // Set background color for the screen
          ...
          return Card(
            ...
            child: Column(
              ...
              children: [
                ...
                SingleChildScrollView( // Prevent overflow when using Row
                  scrollDirection: Axis.horizontal, // Allow horizontal scrolling
                  child: Row(
                    children: dogsOfSameBreed.map((dog) {
                      return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: dogsOfSameBreed.map((dog) {
                    return Container(
                      width: 120, // Set the width for the individual dog card
                      child: Card(
                        elevation: 4.0,
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(dog.name, style: const TextStyle(fontSize: 16)),
                            ),
                            Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
...
class AboutMeScreen extends StatelessWidget {  
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.lightBlue[50],  // Changed background color to pale green
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: const <Widget>[
            Text(
              'Paws & Tails - Adopt a Dog Today',
              style: TextStyle(
                fontSize: 24, 
                fontWeight: FontWeight.bold,
                color: Colors.teal,  // Text color remains teal
              ),
            ),
            SizedBox(height: 10),
            Text(
              'This platform helps you find the perfect dog for adoption. Browse through profiles, meet your future furry friend, and offer them a loving forever home.',
            ...
            SizedBox(height: 10), // Added space between the paragraphs
            Text(
              'If your circumstances change, you can also rehome the dog with ease, ensuring they find a safe and loving new family.',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 16, 
