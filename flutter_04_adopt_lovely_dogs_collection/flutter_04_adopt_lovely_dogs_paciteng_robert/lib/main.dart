    ...
    return MaterialApp(
      theme: ThemeData(
        ...
        scaffoldBackgroundColor:
            Colors.lightBlue[50], // Lighter background color
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        backgroundColor:
            Colors.lightBlue[100], // Lighter background color for the navbar
        onTap: _onItemTapped,
      ),
    );
  }
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            minimumSize: const Size(double.infinity, 50), backgroundColor: Colors.amber,
