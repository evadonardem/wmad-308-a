                    ...
                    if (newValue != null) {
                      fetchBreedImage(newValue.name)
                          ...
                          .catchError((error) {
                            ...
                            logger.e("Error fetching breed image: $error");
                          });
                    }
                  },
                );
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    if (isImageLoading) const CircularProgressIndicator(),
                  ],
                ),
                const SizedBox(height: 20),
              ],
              ...
              ElevatedButton(
                onPressed: () {
                  if (selectedBreed != null && breedImageUrl != null) {
                    ...
                    logger.i('Adopted $randomDogName!');
                  }
                },
                  ...
                  if (selectedBreed != null) {
                    ...
                    fetchBreedImage(selectedBreed!.name)
                        ...
                        .catchError((error) {
                          ...
                          logger.e("Error fetching new breed image: $error");
                        });
                  }
                },
                child:
                    isImageLoading
                        ...
                        : const Text("Show Me Another Dog"),
              ),
            ],
          ),
        ],
