    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme(
          primary: Color.fromARGB(255, 211, 136, 15), 
          primaryContainer: Color.fromARGB(255, 23, 187, 72), 
          secondary: Color.fromARGB(255, 17, 167, 69),
          secondaryContainer: Color.fromARGB(255, 181, 74, 80),
          surface: Color.fromARGB(255, 212, 69, 198), 
          error: Color.fromARGB(255, 255, 0, 30), 
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  trailing: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 167, 141, 201),
                      shadowColor: Colors.white,
                      elevation: 0,
                      textStyle: TextStyle(color: Colors.white),
                      shape: RoundedRectangleBorder(
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text(
'Stop eating cooked dogs......by.. dog meat eat lover',
...
textAlign: TextAlign.left,
              ...
              ElevatedButton.icon(
                ...
                icon: Icon(Icons.email, color: const Color.fromARGB(255, 225, 198, 198)),
                label: Text('Contact', style: TextStyle(color: const Color.fromARGB(255, 206, 187, 187))),
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xFF8D99AE),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
