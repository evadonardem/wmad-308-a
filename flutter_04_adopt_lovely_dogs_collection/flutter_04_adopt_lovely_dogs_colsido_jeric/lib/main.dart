    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme(
          primary: Color.fromARGB(255, 159, 191, 243), // HEX: #b2c2bf
          primaryContainer: Color(0xFFA1E3F9), // HEX: #c0ded9
          secondary: Color(0xFF578FCA), // HEX: #eaece5
          secondaryContainer: Color.fromARGB(255, 246, 203, 155), // HEX: #3b3a30
          surface: Color.fromARGB(255, 51, 85, 240), // HEX: #3b3a30
          error: Color.fromARGB(255, 255, 0, 30), // Red for errors
