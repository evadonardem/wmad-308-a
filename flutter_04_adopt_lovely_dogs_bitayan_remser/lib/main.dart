  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: _onItemTapped,
        type:
            BottomNavigationBarType.fixed, // ✅ Ensures the icons always appear
        selectedItemColor: Colors.deepPurple, // ✅ Custom color for selection
...
class AboutPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Center(child: Text('My name is Remser Bitayan, 21 years old. 3rd Year BSIT student at Kings College of the Philippines.'));
  }
}