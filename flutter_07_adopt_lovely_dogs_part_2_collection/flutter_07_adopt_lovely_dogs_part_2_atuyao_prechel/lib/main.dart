  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(
        title: '"Be the Change: Adopt, Love, and Give Back"',
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: _onItemTapped,
        selectedItemColor: const Color.fromARGB(255, 30, 233, 67),
      ...
      body: Center(
        child: Column(
          ...
          children: const <Widget>[
            Text(
              'Paw WoW - "Be the Change: Adopt, Love, and Give Back"',
              style: TextStyle(
                fontSize: 24,
                fontWeight: FontWeight.bold,
            ...
            Text(
              ...
              'Semper vel class aptent taciti sociosqu ad litora. Conubia nostra inceptos himenaeos orci varius natoque penatibus. '
              'Dis parturient montes nascetur ridiculus mus donec rhoncus. Nulla molestie mattis scelerisque maximus eget fermentum odio.',
